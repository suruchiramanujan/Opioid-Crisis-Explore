...
anim_save("plot_deathsbycommondiseases.gif", plot_deathsbycommondiseases)
...
anim_save("prop_deathsbycommondiseases.gif", prop_deathsbycommondiseases)
...
anim_save("plot_mavsus_death.gif", plot_mavsus_death)
...
ggplot(ageopioidmodel, aes(year, number_of_deaths, color = age_range)) +
  geom_point() +
  scale_color_viridis_d() +
  theme_classic() +
  geom_smooth(method = "lm", se = FALSE) +
...
ggplot(raceopioidmodel, aes(year, opioid_deaths, color = race)) +
  geom_point() +
  scale_color_viridis_d() +
  theme_classic() +
  geom_smooth(method = "lm", se = FALSE) +
...
# averageageopioidmodel <- ageopioidmodel %>%
  # drop_na() %>%
  # group_by(age_range) %>%
  # summarize(mean_deaths = mean(number_of_deaths))

# averageageopioid_model <- lm(mean_deaths ~ age_range, data = averageageopioidmodel)
